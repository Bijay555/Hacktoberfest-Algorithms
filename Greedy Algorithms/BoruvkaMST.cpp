//pedrocns
#include <bits/stdc++.h> 
//Program to find Minimum Spanning Tree of a given connected, undirected and weighted graph 
//Theoretical reference: https://en.wikipedia.org/wiki/Bor%C5%AFvka%27s_algorithm
...
{ 
	...
	{ 
		...
		// Consider the cheapest edges and add them to MST
		for (int i=0; i<V; i++) 
		{ 
			if (cheapest[i] != -1) 
			{ 
